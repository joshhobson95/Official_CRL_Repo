...
function Podcast() {
  return (
    ...
    <img class="podcast_cover" src="https://dev.relationalearning.com/wp-content/uploads/2024/03/podcastcover-e1709657025933.jpg" alt="Center For Relational Learning Podcast Cover" />
    ...
    <button class="to_blogs">Take me to Blogs</button>
    </a>
