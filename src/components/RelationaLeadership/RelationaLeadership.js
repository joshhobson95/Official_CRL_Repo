...
import './RelationaLeadership.css'

function RelationaLeadership() {
  return (
    ...
    <p>
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur ac elit leo. Donec sit amet pharetra nunc, sit amet tincidunt lorem. 
    </p>
    </div>
    </div>
    </div>
    ...
    <ul>
         ...
         <li>RelationaLeadership is an approach to leading that personalizes every interaction between people by progressively increasing everyone’s happiness and success.</li>
         <li>RelationaLeadership guides leaders in the development of relationships that are mutually co-created.</li>
         <li>RelationaLeadership supports leaders to understand and build the skills, sensibilities and practices that increase satisfaction and joy, while developing collective purpose and impact.</li>
         <li>RelationaLeadership helps a person create the way they want to relate.</li>
    </ul>
    </div>
    <div class="leadership_top_image_container"><img class="leadership_top_image" src="https://dev.relationalearning.com/wp-content/uploads/2024/03/IMG_0087.jpg" alt="" /></div>
    </div>
    ...
    <p>
    Our approach sees relational leadership as a developmental process that takes place on two separate but interdependent scales. These scales mirror the relational learning scale where relationships can be developed and progressed in four stages, (1) recognition, (2) understanding, (3) valuing, and finally (4) co-creating and co-sponsoring.
    In our approach leading relationally is developed by simultaneously increasing the leaders satisfaction, joy and happiness and their impact. A client will be able to uncover current patterns of engagement in their relationships. These patterns of relating to other reveal what stage of relating is dominate and then sensibilities and practices are developed to consciously take one to the highest levels of relationship. The chart below is a visual of this dynamic process.
    </p>
    </div>
    <div class="leadership_graphic_container"><img class="leadership_graphic" src="https://dev.relationalearning.com/wp-content/uploads/2024/03/triangle.png" alt="" /></div>
    <div class="leadership_mid_page_quote">
    <h6>“The heart of our work is one on one with people-it’s about building relationships, it is not about meetings-it’s about conversations.
    —Robert Putnam-Better Together</h6>
    </div>
    </div>
    <div class="leadership_lower_page">
    <h2>Characteristics Of RelationaLeadership</h2>
    <p>Relational leaders are skilled guides who engage others where they are on the learning continuum moving them from recognizing, understanding and valuing learning to reciprocal co-creation, a state where everyone is interdependent in productive learning and growth, joy and satisfaction.
    ...
    <div class="orange_wide_paint_container"><img class="orange_wide_paint" src="https://dev.relationalearning.com/wp-content/uploads/2024/02/orange-long.png" alt="" /></div>
    </div>
    </div>
  )
}

export default RelationaLeadership